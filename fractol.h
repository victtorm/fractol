...
/*   Updated: 2024/04/27 17:13:39 by vbritto-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// START_FRACTOL	//julia.to_fractol = fractal;
...
void		close_window_and_julia(t_fractal *fractal);
// KOCH
...
void		update_coord_up(t_koch *m);
void		draw_line_up(t_fractal *koch, t_koch a, t_koch b);
