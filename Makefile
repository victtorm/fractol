FRACTOL_FILES = check_julia.c check_mandelbrot.c fractal_init.c fractal_img.c math_utils.c fractal_events.c events_utils.c koch.c koch_events.c koch_img.c koch_utils.c koch_draw.c
